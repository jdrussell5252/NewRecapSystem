...
{
    public class EditVehicleVinModel : PageModel
    {
        ...
        public IActionResult OnPost(int id)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        string cmdText = "UPDATE Vehicle SET VehicleVin = @VehicleVin WHERE VehicleID = @VehicleID";
                        OleDbCommand cmd = new OleDbCommand(cmdText, conn);
                        cmd.Parameters.AddWithValue("@VehicleVin", Vehicles.VehicleVin);
